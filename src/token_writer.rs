...
pub fn write_escaped_string<OUT: ?Sized + fmt::Write>(string: &str, out: &mut OUT) -> fmt::Result //pub fn write_string_token<ERR, OUT : ?Sized + CharOutput<ERR>>(string : &str, out : &mut OUT) 
//    -> result::Result<(), ERR>
{
